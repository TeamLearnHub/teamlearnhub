...
class MyClassDetailPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return MyClassDetailState();
  }
}

class MyClassDetailState extends State<MyClassDetailPage> {
  String accessToken;
  ...
  Future<CourseDetailResponse> getCourseDetail() async {
    ...
    final http.Response response = await http.get(urlCourseDetail, headers: {
  ...
  Future<List<CourseClassModel>> getCourseClass() async {
    ...
    final http.Response response = await http.get(urlCourseClass, headers: {
      'Content-Type': 'application/json; charset=UTF-8',
      'Accept': 'application/json',
      'Authorization': 'Bearer $accessToken'
    });
