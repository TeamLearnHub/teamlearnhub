...
import 'my_lession_detail.dart';

class MyLearningPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return MyLearningSate();
  }
}

class MyLearningSate extends State<MyLearningPage> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 10),
                      Text('Chương 1 : giới thiệu về học tiếng anh cơ bản',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 16.0,
                          )),
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.of(context)
                              .push(MaterialPageRoute(builder: (context) {
                            return MyLessionPage();
                          }));
                        },
                        child: Text(
                          '1. Giới thiệu tiếng anh ( 2:00 )',
                          style:
